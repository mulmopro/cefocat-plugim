...
# vx_res = 50e-06
# print('\nWARNING: voxel resulution is set to',vx_res,', you may need to change it!!\n')
...
vx_res = float(par['postProc']['vx_res'])#50e-06
print('\nWARNING: voxel resulution is set to',vx_res,', you may need to change it!!\n')
...
tortDict = {
    'nb_samples': str(50),
    'Weight': 'Dist',
    'Export': str(pOut / 'GBTortuosity.txt'),
    'FileNameFull': 'morphOut.fda',
    'FileName': 'morphOut',
    'FileDir':  str(pOut),
    'IN': str(pOut / 'morphOut.fda') , 
...
### Launch Graph-Based Tortuosity

tortGB = plm.run_plugin('GraphBased3D', tortDict, pIn, pOut)
tortGB.copy_exe()
tortGB.edit_xml()
tortGB.run_exe()
...
pp.macroPar(pOut / 'foamtest.tif', vx_res, pOut)

pp.padSTL(pOut / 'foamtest.tif', pOut)